...
typedef trie <std::string, mapped_type, cmp_fn, tag_type, trie_prefix_search_node_update> trie_type;
typedef tree <int, null_mapped_type, std::less<int>, rb_tree_tag, tree_order_statistics_node_update> set_t;
